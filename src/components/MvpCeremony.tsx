...
type Props = { team: string; player: string; score: string; teamColor: string; onRematch: () => void };

export function MvpCeremony({ team, player, score, teamColor, onRematch }: Props) {
  ...
  return (
    <div className="mvp-ceremony">
      ...
      <div className="mvp-stage">
        ...
        <div className="mvp-player" style={teamStyle}><i /><span>🏆</span></div>
